  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='shangjia'"  label="身份证号" prop="shenfenzhenghao">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if( 'shangjia' ==this.flag && this.ruleForm.shenfenzhenghao&&(!checkIdCard(this.ruleForm.shenfenzhenghao))){
