<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">基于个人需求和地域特色的外卖推荐系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.dianpumingcheng" class="input" type="text" placeholder="店铺名称">
			   </div>
			 </div> -->
			<el-form-item label="店铺名称" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.dianpumingcheng" autocomplete="off" placeholder="店铺名称"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   <div class="label">店铺地址</div>
			   <div class="input-container">
			     <input v-model="ruleForm.dianpudizhi" class="input" type="text" placeholder="店铺地址">
			   </div>
			 </div> -->
			<el-form-item label="店铺地址" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.dianpudizhi" autocomplete="off" placeholder="店铺地址"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			...
			<el-form-item label="身份证号" class="input" v-if="tableName=='shangjia'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if(`shangjia` == this.tableName && this.ruleForm.shenfenzhenghao&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzhenghao))){
 ...
 //  }
	...
	.container {
		...
		background-repeat: no-repeat;
    				background-image: url(http://codegen.caihongy.cn/20211111/b0671f1ec6724919b91ca982a9491ab7.svg);
      ...
      box-sizing: border-box;
			...
			background-color: rgba(52, 204, 198, 1);
        ...
        .send-code {
          ...
          line-height:44px;
					...
					border-width: 1px;
					border-style: solid;
					border-color: rgba(23, 79, 137, 0.72);
					border-radius: 4px;
					background-color: rgba(30, 87, 146, 0.72);
          box-shadow: 0 0 6px rgba(255,0,0,0);
				}
