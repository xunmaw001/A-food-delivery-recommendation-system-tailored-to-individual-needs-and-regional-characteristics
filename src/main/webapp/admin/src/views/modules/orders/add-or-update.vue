<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商户名称" prop="shangjiazhanghao">
          <el-input v-model="ruleForm.shangjiazhanghao" 
              placeholder="商户名称" clearable  :readonly="ro.shangjiazhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商户名称" prop="shangjiazhanghao">
              <el-input v-model="ruleForm.shangjiazhanghao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商品类型" prop="goodtype">
          <el-input v-model="ruleForm.goodtype" 
              placeholder="商品类型" clearable  :readonly="ro.goodtype"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商品类型" prop="goodtype">
              <el-input v-model="ruleForm.goodtype" 
...
export default {
  ...
  methods: {
	...
	this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../ssmrt465/upload');
        } else {
