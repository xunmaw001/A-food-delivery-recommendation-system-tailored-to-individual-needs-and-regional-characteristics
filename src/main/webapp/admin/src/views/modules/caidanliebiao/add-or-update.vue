<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="菜名" prop="caiming">
          <el-input v-model="ruleForm.caiming" 
              placeholder="菜名" clearable  :readonly="ro.caiming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="菜名" prop="caiming">
              <el-input v-model="ruleForm.caiming" 
                placeholder="菜名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="菜系分类" prop="caixifenlei">
          <el-select :disabled="ro.caixifenlei" v-model="ruleForm.caixifenlei" placeholder="请选择菜系分类">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="菜系分类" prop="caixifenlei">
	      <el-input v-model="ruleForm.caixifenlei"
                placeholder="菜系分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="口味" prop="kouwei">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="食材" prop="shicai">
          <el-input v-model="ruleForm.shicai" 
              placeholder="食材" clearable  :readonly="ro.shicai"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="食材" prop="shicai">
              <el-input v-model="ruleForm.shicai" 
                placeholder="食材" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="店铺名称" prop="dianpumingcheng">
          <el-input v-model="ruleForm.dianpumingcheng" 
              placeholder="店铺名称" clearable  :readonly="ro.dianpumingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="店铺名称" prop="dianpumingcheng">
              <el-input v-model="ruleForm.dianpumingcheng" 
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='caiming'){
            this.ruleForm.caiming = obj[o];
	    this.ro.caiming = true;
            continue;
          }
          if(o=='tupian'){
      ...
      this.$http({
		...
		if(json.dianpumingcheng!=''&&json.dianpumingcheng){
		...
		if(json.dianpudizhi!=''&&json.dianpudizhi){
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/caixifenlei/caixifenlei`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.caixifenleiOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
	...
	this.ruleForm.jieshao = this.ruleForm.jieshao.replace(reg,'../../../ssmrt465/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `caidanliebiao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.caidanliebiaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
